...
def hill_cipher_encrypt(plain_text, key_matrix):
    ...
    for i in range(0, len(plain_text), n):
        ...
        encrypted_text += "".join([alphabet[int(idx)] for idx in encrypted_chunk])  # Gabungkan hasil enkripsi
...
# Contoh penggunaan
key_matrix = np.array([[6, 24, 1], [13, 16, 10], [20, 17, 15]])  # Matriks kunci
plain_text = "HELLOHILL"  # Teks biasa yang akan dienkripsi
